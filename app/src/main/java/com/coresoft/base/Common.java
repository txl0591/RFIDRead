...
public class Common {
    ...
    public static ArrayList<String> GetStringSegmentPart(Context mContext, RFIDSegmentPart rfid)
    {
        ...
        Segment.add(rfid.cManufacture);
        Segment.add(rfid.cjingshi);
